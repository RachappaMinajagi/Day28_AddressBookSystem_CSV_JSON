...
/**
 * 
 * @author Rachoti create a class PersonContactCsvFile
 *
 */
...
public class PersonContactCsvFile {
	...
	public void csvWriter() throws Exception {
		...
		personList.add(new Person("rachoti", "minajagi", "Mave Hill 025", "gadag", "karnatka", "C25042", "987478963",
				"rachotism@green.com"));
